...
uint8_t ch101_sonicsync_master_init(ch_dev_t *dev_ptr, ch_group_t *grp_ptr, uint8_t i2c_addr, uint8_t io_index, uint8_t bus_index) {
	...
	dev_ptr->fw_text 					= ch101_sonicsync_master_fw;	// Note: entire image is "text"
	dev_ptr->fw_text_size 				= CH101_FW_SIZE;
	dev_ptr->fw_vec 					= NULL;
	dev_ptr->fw_vec_size 				= 0;
...
uint8_t ch101_sonicsync_slave_init(ch_dev_t *dev_ptr, ch_group_t *grp_ptr, uint8_t i2c_addr, uint8_t io_index, uint8_t bus_index) {
	...
	/* Init firmware-specific function pointers */
	dev_ptr->fw_text 					= ch101_sonicsync_slave_fw;		// Note: entire image is "text"
	dev_ptr->fw_text_size 				= CH101_FW_SIZE;
	dev_ptr->fw_vec 					= NULL;
	dev_ptr->fw_vec_size 				= 0;
